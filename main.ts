...
let bgBar = sprites.create(assets.image`myImage4`, SpriteKind.Player)
bgBar.setPosition(145, 90)
let ballBarRight = sprites.create(assets.image`myImage6`, SpriteKind.Player)
...
let lottoMachine = sprites.create(assets.image`myImage3`, SpriteKind.Player)
lottoMachine.x = 58
ball_1 = sprites.create(assets.image`whiteBall`, SpriteKind.Player)
ball_2 = sprites.create(assets.image`yellowBall`, SpriteKind.Player)
ball_3 = sprites.create(assets.image`orangeBall`, SpriteKind.Player)
ball_4 = sprites.create(assets.image`pinkBall`, SpriteKind.Player)
ball_5 = sprites.create(assets.image`brownBall`, SpriteKind.Player)
ball_6 = sprites.create(assets.image`redBall`, SpriteKind.Player)
...
let ballAnimations = sprites.create(assets.image`myImage0`, SpriteKind.Player)
ballAnimations.x = 70
let ballAnimations2 = sprites.create(assets.image`myImage0`, SpriteKind.Player)
ballAnimations2.x = 43
ballAnimations2.y = 60
let ballAnimations3 = sprites.create(assets.image`myImage0`, SpriteKind.Player)
ballAnimations3.x = 70
let ballAnimations4 = sprites.create(assets.image`myImage0`, SpriteKind.Player)
ballAnimations4.setPosition(43, 56)
let ballAnimations5 = sprites.create(assets.image`myImage0`, SpriteKind.Player)
ballAnimations5.setPosition(50, 70)
shoot = sprites.create(assets.image`myImage0`, SpriteKind.Player)
shoot.setPosition(57, 70)
let ballBar = sprites.create(assets.image`myImage5`, SpriteKind.Player)
